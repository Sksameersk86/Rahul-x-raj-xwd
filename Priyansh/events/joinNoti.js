...
module.exports.run = async function({ api, event }) {
    ...
    if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
        ...
        const fs = require("fs");
        return api.sendMessage("", event.threadID, () => api.sendMessage({body: `🍒💙•••Ɓ❍ʈ Ƈøɳɳɛƈʈɛɗ•••𝐑𝐀𝐉 𝐗 𝐃𝐄𝐕 𝐉𝐎𝐒𝐇𝐈 𝐁𝐎𝐒𝐒
...
💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞𝐃𝐄𝐕 𝐉𝐎𝐒𝐇𝐈
☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝐃𝐄𝐕 𝐉𝐎𝐒𝐇𝐈 🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞www.facebook.com/r.j.x.374579\n
👋For Any Kind Of Help Contact On Telegram  Username 👉 @𝐑𝐀𝐉6261😇 
...
`, attachment: fs.createReadStream(__dirname + "/cache/botjoin.mp4")} ,threadID));
        ...
        try {
            ...
            (typeof threadData.customJoin == "undefined") ? msg = "Hello Mr/Miss {name},\n─────────────────\n You're The {soThanhVien}Member ─────────────────\nOf {threadName} Group\n─────────────────\nPlease Enjoy Your Stay\n─────────────────\nAnd Make Lots Of Friends =)\n──────-°°__𝗧𝗿𝘂𝘀𝘁 𝗺e 🔐 °__!!>☁️✨❤️ My Owner  ✦͙͙͙͙❥⃝∗⁎.ʚ 𝐃𝐄𝐕 𝐉𝐎𝐒𝐇𝐈.⁎∗❥⃝**͙✦͙͙͙ ❤️ Love you 😘 ummmma ❤️😍" : msg = threadData.customJoin;
            msg = msg
